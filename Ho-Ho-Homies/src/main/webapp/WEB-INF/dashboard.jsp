...
<body style="background-color: black;">
	<div class="container">
		<div class="row">
			<div class="col-3">
			<a href="https://ibb.co/hmNGWXg"><img src="https://i.ibb.co/P6y2hTr/hohohomies.png" alt="hohohomies"/></a>
			</div>
			<div class="col"></div>
			<div class="col">
				<div class="selection-container">
					...
					<div id="logout-edit" style="color:#45bf65; text-align: right;">
						<div id="Logout">
							...
							<span><a href="/profile/edit?id=${user.id}" class="btn btn-success">Profile</a></span>
						</div>
					</div>
				</div>
			</div>
				...
				<table id="exchange-table" class="table table-danger table-striped">
					...
					<c:forEach var="e" items="${user.exchanges}">
						<tr>
							...
							<td><a href="/event/view?id=${e.event.id}" class="btn btn-sm">View</a></td>
						</tr>
					</c:forEach>
				</table>
				<br> <a href="/event/create" class="btn btn-secondary btn-success btn-sm" id="create-exchange">Create
					Event</a>
			</div>
		</div>
	</div>
