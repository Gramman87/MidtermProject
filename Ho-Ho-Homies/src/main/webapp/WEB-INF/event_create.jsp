...
<body>
	...
	<div class="container">
		<div class="row">
			<img class="w-auto h-100" src="https://i.ibb.co/P6y2hTr/hohohomies.png" alt="hohohomies" />
		</div>
		...
		<div class="row">
			...
			<div class="col-2">Your name here</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-8">
				...
				<div class="row mb-3">
					...
					<div class="col">
						<textarea name="type.description" form="create-form" class="form-control form-control-sm"
				...
				<div class="row mb-3">
					...
					<div class="col">
						<input name="imageURL" form="create-form" class="form-control form-control-sm"
				...
				<div class="row mb-3">
					...
					<div class="col">
						<input name="priceMin" type="number" value="1" form="create-form" class="form-control form-control-sm" required />
					</div>
				</div>
					...
					<div class="row mb-3">
						...
						<div class="col">
							...
							<div class="row mb-3">
								...
								<div class="col">
									<input name="address.zipcode" form="create-form" class="form-control form-control-sm" />
								</div>
							</div>
						</div>
					</div>
