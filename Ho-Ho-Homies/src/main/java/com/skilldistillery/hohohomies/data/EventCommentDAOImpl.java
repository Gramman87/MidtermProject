...
public class EventCommentDAOImpl implements EventCommentDAO {
	...
	public List<EventComment> findAllByExchange(UserExchange exchange) {
		return em	.createQuery(QUERY_PREFIX + "c.exchange=:e", EventComment.class)
	...
	public List<EventComment> findAllByEventId(int id) {
		return em	.createQuery(QUERY_PREFIX + "c.exchange.event.id=:id", EventComment.class)
					.setParameter("id", id)
					.getResultList();
	}
	...
	public List<EventComment> findAllByUserId(int id) {
		return em	.createQuery(QUERY_PREFIX + "c.exchange.user.id=:id", EventComment.class)
					.setParameter("id", id)
					.getResultList();
	}
